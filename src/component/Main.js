...
import WindRose2 from "./WindRose2";
...
const Main = () => {
  ...
  const captions = {
    ...
    const LocationTags = (e) => {
        let value = e.target.value;
        if (e.keyCode === 13) {
            setLocTags([...locTags, value]);
            e.target.value = "";
        }
    }
    ...
    const handleDelQualiTags = (data) => {
        setQualiTags(qualiTags?.filter(tag => tag !== data));
    };

    const handleDelEmpTags = (data) => {
        ...
        <>
            ...
            >
                ...
                <Modal.Body className='customScroll m-2'>
                    <a style={{textAlign:'right',fontSize:'15px',background:'none',float:'right',cursor:'pointer'}} onClick={closeModal}>X</a>
                    <div>
        ...
        <span key={data} className={`${theme == "dark-theme" ? "tags" : "tags-light"} mb-2 mt-2`}>{data} <i class="fa fa-times cursor" aria-hidden="true" onClick={() => handleDelLocTags(data)}></i></span>
                    ...
                    <div className="mt-4">
                        ...
                        <div className="tagsDiv" >
                            {skillTags?.map((data) => {
                                return (
                                    <span className={`${theme == "dark-theme" ? "tags" : "tags-light"} mb-2`} style={{fontFamily:'Lato'}}>{data} <i class="fa fa-times cursor" aria-hidden="true" onClick={() => handleDelSkillTags(data)} style={{fontFamily:'Lato'}}></i></span>
                                )
                            })}
                        </div>
                    </div>
                    ...
                    <div className="d-flex justify-content-center">
                        <button className="searchBtn mt-4" style={{ background: "#6B58D7" }}>Search</button>
                    </div>
            ...
            <div className="logoDiv" style={{marginTop:'-35px'}}>
            ...
            <div className="row">
                ...
                <div className={theme == "dark-theme" ? "col-2 customDiv styleDiv-dark" : "col-2 customDiv styleDiv-light"}>
                    ...
                    <ul className="nav nav-pills flex-column" style={{ gap: "12px" }}>
                    ...
                    <div className="navPagiDiv">
                        <ul className="nav navPagination">
                            {pages?.map((data, index) => {
                                return (
                                    <li className="nav-item itemPages" style={{fontSize:'14.14px'}}>
                                        <NavLink
                ...
                <div className="col-7 customDiv2">
                    ...
                    <div className="row">
                        <div className="col-11">
                            <div className="row">
                                ...
                                <div className="col-8 pr-0 custDiv">
                                    <div className="searchDiv">
                                        ...
                                        <div style={{ position: "relative", width: "92%" }}>
                                            ...
                                            <select className="form-select selectSearch customScroll" style={{fontFamily:'Lato'}}>
                                                <option value="" style={{fontFamily:'Lato'}}>All</option>
                                                <option value="" style={{fontFamily:'Lato'}}>Location</option>
                                                <option value="" style={{fontFamily:'Lato'}}>Skills & Keywords</option>
                                                <option value="" style={{fontFamily:'Lato'}}>Qualifications</option>
                                                <option value="" style={{fontFamily:'Lato'}}>Previous Employers</option>
                                ...
                                <div className="col-4 custDiv2" >
                                    <button className="searchBtn" style={{fontFamily:'Lato',marginRight:'8px'}}>Search</button>
                                    <button className={theme == "dark-theme" ? "showFilterBtn ml-3" : "showFilterBtn-light ml-3"} onClick={openModal} style={{fontFamily:'Lato',fontSize:'13px'}}>Show Filters</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-1 p-0">
                            <div className="d-flex align-items-center" >
                                <img src={profileImg} height={40} width={40} className="cursor" style={{marginRight:'10px'}} />
                                <Link to="/dashboard">
                                    <img src={theme == "dark-theme" ? settingImg : settDarkImg} className="ml-2" height={42} width={30} />
                                </Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row mt-5">
                        ...
                        <div className="col-6 mb-4" >
                            <div  className={theme == "dark-theme" ? "gradBorder-dark radarFont" : "gradBorder-light radarFont"} style={{height:'360px'}}>
                        ...
                        <div className="col-6 mb-4">
                            <div className={theme == "dark-theme" ? "gradBorder-dark" : "gradBorder-light"} style={{height:'360px'}}>
                                <label className="labels">Skills & Keywords</label>

                                <div className="cloudText" style={{ padding: "20px", height: "80%",fontFamily:'Lato' }}>

                                    <ResponsiveContainer  style={{fontFamily:'Lato'}}>
                                        {/* <TagCloud
                      minSize={12}
                      maxSize={35}
                      tags={words}
                ...
                <div className="col-3 customDiv3" style={{marginBottom:'20px'}}>
                    <div className={`${theme == "dark-theme" ? "gradBorderRight-dark" : "gradBorderRight-light"} customScroll`}>
                        ...
                        <div className="mt-4 text-center"  >
                            <h6 className="heads" style={{marginTop:'-10px'}}>RECENT ROLES</h6>
                                    ...
                                    <div>
                                        <div id="faqhead1">
                                            <a href="#" class="btn-header-link" data-toggle="collapse" data-target="#faq1"
                                                aria-expanded="true" aria-controls="faq1" style={{display:'flex'}}><div style={{marginLeft:'4px'}}> {showRole1}</div></a>
                                        </div>

                                        <div id="faq1" class="collapse" aria-labelledby="faqhead1" data-parent="#faq" style={{textAlign:'left',marginLeft:'45px'}}>
                                            <p class="addText">
                                                Anim pariatur
                                            </p>
                                        </div>
                                    ...
                                    <div className="mt-2">
                                        <div id="faqhead2">
                                            <a href="#" class="btn-header-link" data-toggle="collapse" data-target="#faq2"
                                                aria-expanded="true" aria-controls="faq2" style={{display:'flex'}}><div style={{marginLeft:'4px'}}>{showRole2}</div></a>
                                        </div>

                                        <div id="faq2" class="collapse" aria-labelledby="faqhead2" data-parent="#faq" style={{textAlign:'left',marginLeft:'45px'}}>
                                            <p class="addText">
                                                Anim pariatur
                                            </p>
                                        </div>
                                    ...
                                    <div className="mt-2">
                                        <div id="faqhead3">
                                            <a href="#" class="btn-header-link" data-toggle="collapse" data-target="#faq3"
                                                aria-expanded="true" aria-controls="faq3" style={{display:'flex'}}><div style={{marginLeft:'4px'}}>{showRole3}</div></a>
                                        </div>

                                        <div id="faq3" class="collapse" aria-labelledby="faqhead3" data-parent="#faq" style={{textAlign:'left',marginLeft:'45px'}}>
                                            <p class="addText">
                                                Anim pariatur
                                            </p>
                                        </div>
                        ...
                        <div className="mt-3 text-center">
                            <h6 className="heads"  style={{marginTop:'20px'}}> QUALIFICATIONS</h6>
                                    ...
                                    <div>
                                        <div id="faqhead4">
                                            <a href="#" class="btn-header-link" data-toggle="collapse" data-target="#faq4"
                                                aria-expanded="true" aria-controls="faq4"style={{display:'flex'}}><div style={{marginLeft:'4px'}}>{showQuali1}</div></a>
                                        </div>

                                        <div id="faq4" class="collapse" aria-labelledby="faqhead4" data-parent="#faq2" style={{textAlign:'left',marginLeft:'45px'}}>
                                            <p class="addText">
                                                Anim pariatur
                                            </p>
                                        </div>
                                    ...
                                    <div className="mt-2">
                                        <div id="faqhead5">
                                            <a href="#" class="btn-header-link" data-toggle="collapse" data-target="#faq5"
                                                aria-expanded="true" aria-controls="faq5" style={{display:'flex'}}><div style={{marginLeft:'4px'}}>{showQuali2}</div></a>
                                        </div>

                                        <div id="faq5" class="collapse" aria-labelledby="faqhead5" data-parent="#faq2" style={{textAlign:'left',marginLeft:'45px'}}>
                                            <p class="addText">
                                                Anim pariatur
                                            </p>
                                        </div>
                                    ...
                                    <div className="mt-2">
                                        <div id="faqhead6">
                                            <a href="#" class="btn-header-link" data-toggle="collapse" data-target="#faq6"
                                                aria-expanded="true" aria-controls="faq6" style={{display:'flex'}}><div style={{marginLeft:'4px'}}>{showQuali3}</div></a>
                                        </div>

                                        <div id="faq6" class="collapse" aria-labelledby="faqhead6" data-parent="#faq2" style={{textAlign:'left',marginLeft:'45px'}}>
                                            <p class="addText">
                                                Anim pariatur
                                            </p>
                                        </div>
                        ...
                        <div className="mt-3 mb-3 text-center">
                            <h6 className="heads"  style={{marginTop:'20px'}}>FILTER QUESTIONS</h6>
                        ...
                        <div className="mt-3 mb-3 text-center">
                            <h6 className="heads"  style={{marginTop:'20px'}}>RESUME & CONTACT</h6>

                            <div className={theme == "dark-theme" ? "smallBox-dark mx-auto mt-3" : "smallBox-light mx-auto mt-3"}>
                                <div className="filtQues">
                                <div className="d-flex align-items-center justify-content-start mt-3">
                                        <img src={locImg} className="mr-3" />
                                        <p className="addText" >{showAddr}</p>   <img src={pdfImg} className="ml-4" />
                                    </div>
